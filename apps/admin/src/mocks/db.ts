...
export const mockPledges: MockPledgeRecord[] = [
  {
    ...
    userAddress: '0x16dbdb5a6ab9ca0e6a4236721ec4eea290b94765',
    tier: 'Type C',
    stakingType: 'Type C',
    stakingDays: 70,
    deposit: '511,000',
    ...
    endTime: '2026-09-19',
    status: 'redeemed',
    txHash: '0x16dbdb5a6ab9ca0e6a4236721ec4eea290b94765000000000000000000000001',
  },
  {
    id: 'p-17',
    contractId: 'p-17',
...
export const mockWithdrawals: MockWithdrawalRequest[] = Array.from({ length: 10 }, (_, i) => ({
  ...
  amount: (1000.50 + i * 250.75).toFixed(2) + ' USDC',
  handlingFee: (random() * 5 + 1).toFixed(2) + ' USDC',
