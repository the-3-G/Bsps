...
export const mockUsers: MockUser[] = [
  {
    ...
    handle: '@user_1495',
    inviteCode: 'INV-1495',
    email: 'user1495@bspc.io',
    role: 'user',
    balanceUsdt: '57980',
    balanceEth: '3.1000',
    onChainVerifiedUsdc: '57980',
    withdrawalTotal: '0',
    collectionTotal: '26151358',
    status: 'active',
  ...
  ...Array.from({ length: 25 }, (_, i) => ({
    ...
    role: (i === 0 ? 'admin' : i === 1 ? 'manager' : 'user') as MockUser['role'],
    ...
    status: (i % 8 === 0 ? 'suspended' : 'active') as MockUser['status'],
    collectionStatus: (i % 5 === 0 ? 'inactive' : 'active') as MockUser['collectionStatus'],
    otherAuth: (i % 3 === 0 ? 'two-factor' : i % 3 === 1 ? 'email-verified' : 'none') as MockUser['otherAuth'],
...
export const mockPledges: MockPledgeRecord[] = [
  {
    id: 'p-17',
    contractId: 'p-17',
    userId: '0x149534751f4f85af01ce291fd2be194c8950441d',
    userAddress: '0x149534751f4f85Af01ce291FD2be194c8950441d',
    tier: 'Tier A',
    stakingType: 'Tier A',
    stakingDays: 30,
    deposit: '57980',
    ...
    ethReward: '3.1',
    bonusReward: '3.1',
    participationTime: new Date(2026, 7, 26).toISOString(),
    endTime: '2026-10-05T05:07',
    status: 'completed',
    txHash: '0x149534751f4f85af01ce291fd2be194c8950441d000000000000000000000001',
  },
  {
    id: 'p-16',
    contractId: 'p-16',
    ...
    ethReward: '3.1000',
    bonusReward: '3.1 ETH',
    participationTime: new Date(2026, 7, 25).toISOString(),
    endTime: new Date(2026, 8, 25).toISOString(),
    status: 'mining',
    txHash: '0x149534751f4f85af01ce291fd2be194c8950441d000000000000000000000000',
  },
  ...Array.from({ length: 15 }, (_, i) => ({
    ...
    stakingType: `Tier ${['A', 'B', 'C', 'D'][i % 4]}`,
    stakingDays: 30,
    deposit: (1000 * (i + 1)).toString(),
    amountThreshold: (1000 * (i + 1)).toString(),
    miningRatio: `${(1.5 + (i % 3) * 0.5).toFixed(1)}%`,
    interestRate: `${(1.5 + (i % 3) * 0.5).toFixed(1)}%`,
