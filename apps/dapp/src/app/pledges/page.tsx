          ...
          const fetched = snap.docs
            ...
            .map((d) => {
              ...
              return {
                ...
                period: data.stakingDays ? (String(data.stakingDays).includes('day') ? String(data.stakingDays) : `${data.stakingDays} days`) : '30 days',
                ...
                endTime: data.endTime || '2026-10-05 05:07',
